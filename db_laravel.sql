...
-- Thời gian đã tạo: Th3 25, 2021 lúc 02:00 PM
...
--
-- Cấu trúc bảng cho bảng `cart_shopping`
--
...
--
-- Đang đổ dữ liệu cho bảng `cart_shopping`
--
...
--
-- Cấu trúc bảng cho bảng `list_name`
--
...
--
-- Đang đổ dữ liệu cho bảng `list_name`
--
...
--
-- Cấu trúc bảng cho bảng `name_pro`
--
...
--
-- Đang đổ dữ liệu cho bảng `name_pro`
--
...
(1, 'Nạc heo xay túi 200g', 36000, 0.2, 0, 3, '24h', 'thịt heo tươi', '1616600343-product.jpg', 1, NULL, NULL),
(2, 'Chân giò heo sau khay 500g', 65000, 0.5, 0, 3, '24h', 'thịt heo tươi', '1616434799-product.jpg', 1, NULL, NULL),
