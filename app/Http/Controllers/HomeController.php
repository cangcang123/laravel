...
class HomeController extends Controller
{
    ...
    public function name($id){
        ...
        return view('pages.name',compact('name','product','name_pro'));
    ...
    public function product($id){
        ...
        return view('pages.product',compact('name','name_pro'));
    }
    public function listsp($id){
        ...
        return view('pages.list',compact('name','product','name_pro'));
    }
